...
import com.playquiz.quizapp.service.QuizService;
...
public class QuizController {
    ...
    @PostMapping("create")
    public ResponseEntity<String> createQuiz(@RequestParam String category,@RequestParam Integer noOfQns,@RequestParam String title){
//        return new ResponseEntity<>("Here it is...", HttpStatus.OK);
